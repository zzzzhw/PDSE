...
# 文件路径列表（替换为你的文件路径）
file_paths = [
    "../cade/01.21-14.35.33/cade_apigraph_127_warm_lr0.0001_adam_cosine_1_e100_wlr5e-05_we50_mwlr5e-05_mwe50_test_2013-01_2018-12_cnt200.csv",
...
for file_path in file_paths:
    ...
    if 'FNR' in df.columns:
        aut_data.append(df['FNR'])
    else:
        print(f"Warning: 'FNR' column not found in {file_path}")
