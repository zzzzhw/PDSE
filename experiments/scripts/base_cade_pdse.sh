...
TEST_START=2013-01
TEST_END=2018-12
RESULT_DIR=results/cade_pdse_combined
MODEL_DATE=20230501
...
MODEL_DIR=models/cade_pdse_combined/${CNT}
RUN_NAME=cade_pdse_combined_apigraph_cnt${CNT}_${SEQ}_seed${SEED}_test_${TEST_START}_${TEST_END}
