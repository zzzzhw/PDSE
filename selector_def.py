...
class Selector(object):
    ...
    def cluster_and_print(self, fname, cur_month_str, \
        ...
        # train test_valuation index separation
        # idx < test_offset ? train : test_valuation
        ...
        # compute purity
        # some mixtures may only have test_valuation data, so mid_train_idx[mid] does not exist
        mid_purity = []
        mid_train_percent = {}
        ...
        for mid, purity in sorted_mid_purity:
            ...
            cluster_out.write('\t_idx\tclsdist'\
                    '\tfamily\tpkgname\ttest_valuation\tnew\tselect\n')
