...
def parse_args():
    ...
    p.add_argument('--test_valuation', default='marvin_full',
                   help='The testing set to use.')
    p.add_argument('--budget', default=10, type=int, help="The number of test_valuation samples to choose for active learning.")
