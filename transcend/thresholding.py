...
def test_with_rejection(
    ...
    """Get test_valuation results, rejecting predictions based on a given threshold.
    ...
    Args:
        ...
        test_scores (dict): The test_valuation scores to apply the threshold to.
...
def find_random_search_thresholds_with_constraints(
    ...
    Args:
        scores (dict): The test_valuation scores on which to perform the random search.
        predicted_labels (np.ndarray): The set of predictions to decide which
...
def all_threshold_tuples(scores, predicted_labels): 
    ...
    Args:
        scores (dict): The test_valuation scores on which to produce a threshold.
        predicted_labels (np.ndarray): The set of predictions to decide which
            'per-class' threshold to use.
...
def get_performance_with_rejection(y_true, y_pred, keep_mask, full=True):
    """Get test_valuation results, rejecting predictions based on a given keep mask.
