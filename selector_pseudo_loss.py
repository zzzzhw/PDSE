...
class LocalPseudoLossSelector(Selector):
    ...
    def select_samples(self, args, X_train, y_train, y_train_binary, \
        ...
        # each batch is to get one loss for one test_valuation sample
        ...
        for i in range(sample_num):
            ...
            # bsize-1 nearest neighbors of the test_valuation sample i
            ...
            # call the loss function once for every test_valuation sample
            ...
            # only display the test_valuation samples
